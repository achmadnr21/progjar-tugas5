...
class BackendList:
    def __init__(self):
        self.servers = []
        self.servers.append(('172.16.16.101', 9002))
        self.servers.append(('172.16.16.101', 9003))
        self.servers.append(('172.16.16.101', 9004))
        self.servers.append(('172.16.16.101', 9005))
        self.current = 0
...
class Server:
    def __init__(self, portnumber: int):
        ...
        self.socket.bind(('172.16.16.101', portnumber))
